...
*/
/**
 * Created by Uporabnik on 15. 06. 2016.
 *//*
...
public class Downloader {
    ...
    */
/*
     * Tazred za prenos datoteke
     *//*



    //Tag for Log statements
    private static String myTag = "BusTalktrack";
    private static String URL = "http://bus.lpp.si/";
...
/************************************************
    ...
    public void DownloadFromUrl(FileOutputStream fos) {  //this is the downloader method
        try {

            URL url = new URL(this.URL); //URL of the file
...
/************************************************
            ...
            */
/************************************************
             * Define OutputStreams to writ e to our file.
             ************************************************//*
