...
/**
 * Created by Uporabnik on 16. 07. 2016.
 */
...
//    }
    ...
    public void onStart() {
        ...
        Action viewAction = Action.newAction(
                ...
                "Drugizaslon Page", // TODO: Define a title for the content shown.
                // TODO: If you have web page content that matches this app activity's content,
                // make sure this auto-generated web page URL is correct.
                // Otherwise, set the URL to null.
                Uri.parse("http://host/path"),
                // TODO: Make sure this auto-generated app URL is correct.
                Uri.parse("android-app://com.example.bus.uporabnik.busaplication/http/host/path")
        );
...
//    }
    public class JsonTask extends AsyncTask<String, String, JSONObject> {
        ...
        private String Urlstr = "http://www.trola.si/";
...
//              Log.i("doInBackground", String.valueOf(seznam));
            ...
            GlavniPodatki = rezultat.getStringArray(rawData);
            mAdapter.setData(GlavniPodatki);

            postaje = rezultat.getStations(rawData);
            mAdapter.setData(postaje);
